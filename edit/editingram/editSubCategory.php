...
if(isset($_POST['update']))
{
    ...
    if(empty($SubCategoryNo) || empty($SubCategoryName) || empty($Margin) || empty($MarginNewEgg)) {
        ...
        //updating the table
        $result = mysqli_query($mysqli, "UPDATE ingramCatList SET SubCategoryNo='$SubCategoryNo',SubCategoryName='$SubCategoryName',Margin='$Margin',MarginNewEgg='$MarginNewEgg' WHERE Id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM ingramCatList WHERE Id=$id");
