...
{	
	...
	if(empty($CategoryNo) || empty($CategoryName) || empty($Margin) || empty($MarginNewEgg)) {
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE ingramCatList SET CategoryName='$CategoryName',Margin='$Margin',MarginNewEgg='$MarginNewEgg' WHERE CategoryNo=$CategoryNo");
...
$result = mysqli_query($mysqli, "SELECT * FROM ingramCatList WHERE CategoryNo=$CategoryNo Group by CategoryNo");
