...
{	
	...
	if(empty($CategoryNo) || empty($CategoryName) || empty($Margin) || empty($MarginNewEgg)) {
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE dhCatList SET CategoryName='$CategoryName',Margin='$Margin',MarginNewEgg='$MarginNewEgg' WHERE CategoryNo=$CategoryNo");
...
$result = mysqli_query($mysqli, "SELECT * FROM dhCatList WHERE CategoryNo=$CategoryNo Group by CategoryNo");
