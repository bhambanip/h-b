...
$MARKETPLACE_ID_ARRAY = array("Id" => array('A2EUQ1WTGCTBG2'));
...
$UPLOAD_FILES2 = array('/var/www/html/MarketplaceWebService/data/asiAmzFile.txt', '/var/www/html/MarketplaceWebService/data/synAmzFile.txt');
